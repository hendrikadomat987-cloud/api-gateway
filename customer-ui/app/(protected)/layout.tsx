// customer-ui/app/(protected)/layout.tsx
//
// Shared sidebar + topbar layout for all authenticated pages.
// The middleware already guards these routes — this layout can trust the
    ...
    <div className="flex min-h-screen">
      ...
      <aside className="hidden w-64 flex-shrink-0 border-r border-gray-200 bg-white lg:flex lg:flex-col">
        ...
        <div className="flex h-16 items-center gap-2 border-b border-gray-200 px-6">
          ...
          <span className="text-sm font-semibold text-gray-900">Voice Agent</span>
        </div>
          ...
          <ul className="space-y-1">
            {NAV_ITEMS.map(item => (
              <li key={item.href}>
                <Link
                  href={item.href}
                  className="group flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-blue-600"
                >
                  <svg className="h-5 w-5 flex-shrink-0 text-gray-400 group-hover:text-blue-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <div className="border-t border-gray-200 p-3">
          <form action={logoutAction}>
            <button
              type="submit"
              className="flex w-full items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-red-600"
            >
